...
sshpass -p 'veery' ssh -o StrictHostKeyChecking=no root@192.168.0.2 "cat /root/telem_pyADCS.csv" > ~/careweather/operations/Data_reading/raw_data_files/$output_file_name.csv
